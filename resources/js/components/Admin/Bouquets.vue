<template>
    <div class="row" v-if="props?.orderSummary?.timeSlot?.bouquets">
        <div class="col-lg-2 mt-4 text-center" v-for="item in props.orderSummary.timeSlot.bouquets" :key="item.id">
...
let state = bouquets.value;
let existingDetails = props?.params?.existing?.bouquets;
