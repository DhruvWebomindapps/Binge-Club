<template>
    <div class="row" v-if="props?.orderSummary?.timeSlot?.cakes">
        <div class="col-lg-2 mt-4 text-center" v-for="item in props.orderSummary.timeSlot.cakes" :key="item.id">
...
let state = cakes.value;
let existingDetails = props?.params?.existing?.cakes;
