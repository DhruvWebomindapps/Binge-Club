<template>
    <div class="row" v-if="props?.orderSummary?.timeSlot?.gifts">
        <div class="col-lg-2 mt-4 text-center" v-for="item in props.orderSummary.timeSlot.gifts" :key="item.id">
...
let existingDetails = props?.params?.existing?.gifts;
