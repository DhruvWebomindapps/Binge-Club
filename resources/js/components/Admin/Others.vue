<template>
    <div class="row" v-if="props?.orderSummary?.timeSlot?.others">
        <div class="col-lg-2 mt-4 text-center" v-for="item in props.orderSummary.timeSlot.others" :key="item.id">
...
let state = others.value;
let existingDetails = props?.params?.existing?.others;
