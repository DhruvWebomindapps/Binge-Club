<template>
    <div class="row" v-if="props?.orderSummary?.timeSlot?.snacks">
        <div class="col-lg-2 mt-4 text-center" v-for="item in props.orderSummary.timeSlot.snacks" :key="item.id">
...
let state = snacks.value;
let existingDetails = props?.params?.existing?.snacks;
