                        ...
                        <form action="" method="get">
                            <div class="row">
                                ...
                                <div class="col-md-1">
                                    ...
                                    <a href="{{ url('admin/upcoming/bookings') }}" class="btn btn-danger">
                                        reset
                                    </a>
                                </div>
                            </div>
                        </form>
                        <input type="hidden" id="current_route" value="{{ url('admin/upcoming/bookings') }}">
                        <div class="row">
                            <div class="col-md-12 dataTableDiv">
                                <table class="table">
                                    ...
                                    <tbody>
                                        @foreach ($bookings as $key => $b_list)
                                            <tr class="{{ $b_list->status == 'pending' ? 'maroon' : '' }}">
                                                ...
                                                <td>{{ $b_list->getScreen ? $b_list->getScreen->screen_name : '' }}</td>
