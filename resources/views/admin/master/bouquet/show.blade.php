                            ...
                            <div class=" row mt-3">
                                <div class="col col-lg-6">
                                    ...
                                    <select class="form-select" aria-label="Default select example" name="city_id"
                                        id="city_id">
                                        <option value="{{ $bouquetData->id }}" selected>{{ $bouquetData->getCity?->name }}
                                        </option>
                                    </select>
                                </div>
                                <div class="col col-lg-6">
                                    ...
                                    <select class="form-select" aria-label="Default select example" name="location_id"
                                        id="location_id">
                                        <option value="{{ $bouquetData->id }}" selected>
                                            {{ optional($bouquetData->getLocation)->name }}
                                        </option>
                            ...
                            <div class=" row mt-3">
                                <div class="col col-lg-6">
                                    ...
                                    <input type="text" class="form-control" id="name_id" name="title"
                                        value="{{ $bouquetData->title }}" required>
                                    @if ($errors->has('title'))
                                ...
                                <div class="col col-lg-6">
                                    ...
                                    <input type="text" class="form-control" id="price_id" name="price"
                                        value="{{ $bouquetData->price }}" required />
                                </div>
                            </div>
                            <div class="row mt-4">
                                <div class="col-lg-6">
                                    <img src="{{ asset('storage/' . $bouquetData->icon) }}" alt=""
