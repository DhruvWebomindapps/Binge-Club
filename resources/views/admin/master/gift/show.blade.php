                            ...
                            <div class=" row mt-3">
                                <div class="col col-lg-6">
                                    ...
                                    <select class="form-select" aria-label="Default select example" name="city_id"
                                        id="city_id">
                                        <option value="{{ $giftData->id }}" selected>{{ $giftData->getCity?->name }}
                                        </option>
                                    </select>
                                </div>
                                <div class="col col-lg-6">
                                    ...
                                    <select class="form-select" aria-label="Default select example" name="location_id"
                                        id="location_id">
                                        <option value="{{ $giftData->id }}" selected>
                                            {{ optional($giftData->getLocation)->name }}
                                        </option>
                            ...
                            <div class=" row mt-3">
                                ...
                                <div class="col col-lg-6">
                                    ...
                                    <input type="text" class="form-control" id="price_id" name="price"
                                        value="{{ $giftData->price }}" required />
                                </div>
                            </div>
                            <div class="row mt-4">
                                <div class="col-lg-6">
                                    <img src="{{ asset('storage/' . $giftData->icon) }}" alt=""
