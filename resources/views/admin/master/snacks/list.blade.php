            ...
            <div class="col col-md-12">
                <div class="card">
                    <div class="p-4 pb-0">
                        <h4>
                            Snacks List
                            <a href="{{ url('admin/master/snacks/create') }}" class="btn btn-info create">
                    ...
                    <div class="card-body">
                        ...
                        @endphp
                        <x-table :columns="$columns" :data="$lists" :route="url('admin/master/snacks')" :locations="$locations">
                            @foreach ($lists as $list)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('admin/master/snacks/changeStatus/' . $list->id) }}"
                                    ...
                                    <td class="action-btn">
                                        <a href="{{ url('admin/master/snacks/' . $list->id) }}">
                                            <i class='fas fa-eye'></i>
                                        </a>
                                        <a href="{{ url('admin/master/snacks/' . $list->id . '/edit') }}">
                                            <i class='far fa-edit'></i>
                                        </a>
                                        @role('super-admin')
                                        <a href="{{ url('admin/master/snacks/delete/' . $list->id) }}"
    ...
    @push('scripts')
        <script>
            function changePriority(id) {
                ...
                jQuery.ajax({
                    type: "GET",
                    url: "{{ route('update.snacks.priority') }}",
                    datatype: "text",
                    data: {
                        id: id,
                        value: value
