                            ...
                            <div class=" row mt-3">
                                <div class="col col-lg-6">
                                    ...
                                    <select class="form-select" aria-label="Default select example" name="city_id"
                                        id="city_id">
                                        <option value="{{ $snacksData->id }}" selected>{{ $snacksData->getCity?->name }}
                                        </option>
                                    </select>
                                </div>
                                <div class="col col-lg-6">
                                    ...
                                    <select class="form-select" aria-label="Default select example" name="location_id"
                                        id="location_id">
                                        <option value="{{ $snacksData->id }}" selected>
                                            {{ optional($snacksData->getLocation)->name }}
                                        </option>
                            ...
                            <div class=" row mt-3">
                                <div class="col col-lg-6">
                                    ...
                                    <input type="text" class="form-control" id="name_id" name="title"
                                        value="{{ $snacksData->title }}" required>
                                    @if ($errors->has('title'))
                                ...
                                <div class="col col-lg-6">
                                    ...
                                    <input type="text" class="form-control" id="price_id" name="price"
                                        value="{{ $snacksData->price }}" required />
                                </div>
                            </div>
                            <div class="row mt-4">
                                <div class="col-lg-6">
                                    <img src="{{ asset('storage/' . $snacksData->icon) }}" alt=""
