            ...
            <tbody>
                <tr style="width:20%;">
                    <td style="text-align: center; width:20%;">
                        {{-- <img src="{{ public_path('frontend/assets/image/home/binge_city_logo.png') }}"
                            alt="logo"><br /> --}}
                        <img src="{{ public_path('frontend/assets/image/home/binge_city_logo.png') }}" alt="logo"
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td valign="top" align="center"
                                        ...
                                        <img src="{{ public_path('storage/' . $image?->screen_icon) }}" width="100"
                                            height="100"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td style="padding-left: 0;">
                                                        <span
                                                            style="display:block;font-size:13px;color:#828282;font-weight:400;padding-top:5px"><span>PVR:
                                            ...
                                            <tbody>
                                                ...
                                                <tr
                                                    ...
                                                    <td style="font-size: 14px; padding: 12px 10px; text-align:end;">
                                                        <span
                                                            style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                                                        {{ $booking->number_of_people * $booking->additional_amount }}
                                                    </td>
                                                </tr>
                ...
                <tr>
                    <td style="padding: 5px 15px 15px 15px;">
                        <table width="" border="0" cellpadding="0" cellspacing="0" align="left"
                            ...
                            <tbody>
                                <tr>
                                    <th style="font-weight: 500; font-size: 16px;"> CONVENIENCE FEES</th>
                                    <th>&nbsp;</th>
                                    <th style="font-weight: 500; font-size: 16px; text-align: right;">
                                        Amount
                                    </th>
                                </tr>
                                <tr>
                                ...
                                <tr style="font-size: 14px;">
                                    <td>
                                        {{ $booking ? $booking->screen_name : '' }}
                                        (
                                        @foreach ($booking->slots as $key => $slot)
                                            {{ $slot->slot_name }},
                                        @endforeach
                                        )
                                        {{-- ({{ $booking ? $booking->time_slot : '' }}) --}}
                                    </td>
                                    <td>&nbsp;</td>
                                    <td style="text-align: right;">
                                        <span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                                        {{ $booking ? $booking->time_slot_amount : '' }}
                                    </td>
                                </tr>
