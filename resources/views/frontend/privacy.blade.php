<x-home-layout>
    ...
    <section class="ptb term-condition bg-theme">
        <div class="container">
            <div class="row">
                <div class="col-lg-10 rounded mx-auto p-lg-5 p-4 bg-white shadow-sm">
                    ...
                    <h4 class="py-4">Interpretation</h4>
                    <p>
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            to Sahivas Online Services Pvt Ltd, #334, 4th floor, 27th Main, Sector 1, HSR Layout,
                            Bangalore - 560037.
                        </li>
                        <li>
                        ...
                        <li>Website refers to Binge Club, accessible from <a
                                href="http://thebingeclub.in">http://thebingeclub.in</a> </li>
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <p>
                                ...
                                you use to access the Website. We may also use these Cookies to test new pages, features
                    ...
                    <h6>Instamojo</h6>
                    <p>Their Privacy Policy can be viewed at https://www.instamojo.com/company/privacy/</p>
                    ...
                    <ul>
                        <li>By email: <a href="mailto:contact@bingeclub.in">contact@bingeclub.in</a> </li>
                    </ul>
                </div>
            </div>
        </div>
